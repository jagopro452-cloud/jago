<aside class="aside">
    ...
    <div class="aside-header">
        ...
        <a href="{{route('admin.dashboard')}}" class="logo d-flex gap-2">
            <img width="115"
                 src="{{$logo ? dynamicStorage("storage/app/public/business/".$logo) : dynamicAsset('public/jago-logo.png')}}"
                 alt="" class="main-logo">
        </a>
        <!-- End Logo -->
        ...
        <div class="aside-body" data-trigger="scrollbar">
            ...
            <ul class="main-nav nav">
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['trip_view', 'trip_edit', 'trip_delete', 'trip_log', 'trip_export']))
                    ...
                    <li class="{{ Request::is('admin/trip/car-sharing*') ?'active sub-menu-opened':'' }} text-capitalize">
                        <a href="{{route('admin.trip.car-sharing.index')}}">
                            <i class="bi bi-people-fill"></i>
                            <span class="link-title">{{ translate('car_sharing') }}</span>
                        </a>
                    </li>
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['promotion_view', 'promotion_add', 'promotion_edit', 'promotion_delete', 'promotion_log', 'promotion_export']))
                    ...
                    <!-- Coupon Setup End-->
                    <li class="{{ Request::is('admin/promotion/spin-wheel*')?'active open':'' }}">
                        <a href="{{route('admin.promotion.spin-wheel.index')}}">
                            <i class="bi bi-trophy-fill"></i>
                            <span class="link-title text-capitalize">{{ translate('spin_wheel') }}</span>
                        </a>
                    </li>
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['user_view', 'user_add', 'user_edit', 'user_delete', 'user_log', 'user_export']))
                    ...
                    <li class="{{Request::is('admin/subscription*')? 'active open' : ''}}">
                        <a href="{{route('admin.subscription.index')}}">
                            <i class="bi bi-card-checklist"></i>
                            <span class="link-title text-capitalize">{{translate('subscription_plans')}}</span>
                        </a>
                    </li>
                    <!---------- End user Management --------------->
                @endif
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['chatting_view']))
                    ...
                    <li class="{{Request::is('admin/call-management*') ?'active open':''}}">
                        <a href="{{route('admin.call.logs')}}">
                            <i class="bi bi-telephone-fill"></i>
                            <span class="link-title">{{ translate('call_logs') }}</span>
                        </a>
                    </li>
