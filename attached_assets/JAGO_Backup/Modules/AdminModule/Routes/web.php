...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function () {
    ...
    Route::controller(CallController::class)->prefix('call-management')->as('call.')->group(function () {
        Route::get('logs', 'adminCallLogs')->name('logs');
        Route::get('recording/{recordingId}', 'playRecording')->name('recording');
    });

    Route::controller(DriverOverchargeController::class)->prefix('overcharge-management')->as('overcharge.')->group(function () {
        Route::get('reports', 'adminOverchargeReports')->name('reports');
        Route::post('block/{reportId}', 'adminBlockDriver')->name('block');
        Route::post('dismiss/{reportId}', 'adminDismissReport')->name('dismiss');
    });
});
Route::controller(SharedController::class)->group(function () {
