...
class BusinessSettingStoreOrUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "subscription_model_enabled" => "nullable",
            "free_ride_limit" => "nullable|numeric|gte:0",
            "negative_balance_limit" => "nullable|numeric|gt:0",
            "parcel_commission_enabled" => "nullable",
            "parcel_commission_percent" => "nullable|numeric|gte:0|lte:100",
            "car_sharing_enabled" => "nullable",
            "earning_model" => "nullable|in:commission,subscription",
            "platform_fee_amount" => "nullable|numeric|gte:0",
        ];
    }
