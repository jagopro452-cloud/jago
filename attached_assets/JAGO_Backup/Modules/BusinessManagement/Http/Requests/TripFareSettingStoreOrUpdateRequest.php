...
class TripFareSettingStoreOrUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'waiting_fee_free_minutes' => [Rule::requiredIf(function () {
                return $this->input('type') === TRIP_FARE_SETTINGS;
            }), 'numeric', 'min:0'],
            'cancellation_free_distance' => [Rule::requiredIf(function () {
                return $this->input('type') === TRIP_FARE_SETTINGS;
            }), 'numeric', 'min:0'],
            ...
            "helper_service_enabled" => "nullable|string|in:on",
            "helper_rate_per_hour" => "nullable|numeric|min:1",
        ];
    }
