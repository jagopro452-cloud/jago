        ...
        <div class="container-fluid">
            ...
            <div class="page-header d-flex flex-wrap gap-3 align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="m-0">
                        {{translate('connect_6ammart_system_with_jago')}}
                    </p>
                </div>
                            ...
                            <div class="mb-3">
                                <div class="border rounded d-flex flex-wrap gap-2 align-items-center p-3 p-sm-4">
                                    <div class="w-160px flex-grow-1">
                                        ...
                                        <p class="fs-12 m-0">
                                            {{translate('Enable the switch to activate the purchased Software- 6amMart in the JAGO system. You must input the correct information to make sure the functionality works properly.')}}
                                        </p>
                                    </div>
                                    <label class="switcher ml-auto mb-0">
                                        <input
                                            ...
                                            class="switcher_input" {{ ($settings->firstWhere('key', 'activation_mode')->value ?? 0) == 1 ? 'checked' : '' }} {{config('app.mode')=='demo' ? 'disabled' : ''}}>
                                ...
                                <div class="col-sm-12">
                                    <div class="p-3 p-sm-4 bg-body rounded">
                                        <div class="d-flex justify-content-between">
                                            <label
                                                class="mb-2">{{ (businessConfig('business_name')?->value ?? "JAGO"). ' ' .translate('System Token') }}
                                                <i
                                                    class="bi bi-info-circle-fill text-primary cursor-pointer"
                                                    data-bs-toggle="tooltip"
                                                    data-bs-title="{{translate("Click on the Generate Token button, It will automatically generate the JAGO System Token and insert it into the input field.")}}">
                                                </i>
                                            </label>
                                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 pt-0 px-lg-5">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <h5 class="mb-2">{{(businessConfig('business_name')?->value ?? "JAGO" ) . ' ' .translate('System Token Generate')}}</h5>
                                        <p>
                                            ...
                                            {{(businessConfig('business_name')?->value ?? "JAGO") . ' ' .translate('System Token Generate')}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="pb-1">
                                <i class="text-dark">{{translate('Note :  Follow the same steps on 6amMart to successfully connect JAGO with 6amMart')}}</i>
                            </div>
                        </div>
                    </div>
                </div>
