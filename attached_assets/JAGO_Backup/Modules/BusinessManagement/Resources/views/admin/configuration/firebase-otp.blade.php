                    ...
                    <div class="card-body">
                        <form action="{{route('admin.business.configuration.third-party.firebase-otp.update')}}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="firebase_otp_web_api_key" tabindex="2"
                                               value="{{ is_array($firebaseOtpValues->firstWhere('key_name','firebase_otp_web_api_key')?->value) ? json_encode($firebaseOtpValues->firstWhere('key_name','firebase_otp_web_api_key')?->value) : $firebaseOtpValues->firstWhere('key_name','firebase_otp_web_api_key')?->value }}"
                            ...
                            <div class="d-flex flex-wrap gap-3 justify-content-end mt-3">
                                ...
                                <button type="{{ config('app.mode') != 'demo' ? 'submit' : 'button' }}" tabindex="4"
