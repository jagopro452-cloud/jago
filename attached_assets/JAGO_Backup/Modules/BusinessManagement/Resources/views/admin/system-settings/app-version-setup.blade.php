                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="number" name="minimum_customer_app_version_for_android"
                                                   step="0.001"
                                                   value="{{ config('app.mode')!='demo'?(($customerAppVersionControlForAndroid && array_key_exists('minimum_app_version',$customerAppVersionControlForAndroid)) ? $customerAppVersionControlForAndroid['minimum_app_version'] : old('minimum_customer_app_version_for_android')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="url" name="customer_app_url_for_android"
                                                   value="{{ config('app.mode')!='demo'?(($customerAppVersionControlForAndroid && array_key_exists('app_url',$customerAppVersionControlForAndroid)) ? $customerAppVersionControlForAndroid['app_url'] : old('customer_app_url_for_android')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="number" name="minimum_customer_app_version_for_ios" step=".001"
                                                   value="{{ config('app.mode')!='demo'?(($customerAppVersionControlForIos && array_key_exists('minimum_app_version',$customerAppVersionControlForIos)) ? $customerAppVersionControlForIos['minimum_app_version'] : old('minimum_customer_app_version_for_ios')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="url" name="customer_app_url_for_ios"
                                                   value="{{ config('app.mode')!='demo'?(($customerAppVersionControlForIos && array_key_exists('app_url',$customerAppVersionControlForIos)) ? $customerAppVersionControlForIos['app_url'] : old('customer_app_url_for_ios')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="number" name="minimum_driver_app_version_for_android"
                                                   step=".001"
                                                   value="{{ config('app.mode')!='demo'?(($driverAppVersionControlForAndroid && array_key_exists('minimum_app_version',$driverAppVersionControlForAndroid)) ? $driverAppVersionControlForAndroid['minimum_app_version'] : old('minimum_driver_app_version_for_android')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="url" name="driver_app_url_for_android"
                                                   value="{{ config('app.mode')!='demo'?(($driverAppVersionControlForAndroid && array_key_exists('app_url',$driverAppVersionControlForAndroid)) ? $driverAppVersionControlForAndroid['app_url'] : old('driver_app_url_for_android')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="number" name="minimum_driver_app_version_for_ios" step=".001"
                                                   value="{{ config('app.mode')!='demo'?(($driverAppVersionControlForIos && array_key_exists('minimum_app_version',$driverAppVersionControlForIos)) ? $driverAppVersionControlForIos['minimum_app_version'] : old('minimum_driver_app_version_for_ios')) : ''}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            ...
                                            <input type="url" name="driver_app_url_for_ios"
                                                   value="{{ config('app.mode')!='demo'?(($driverAppVersionControlForIos && array_key_exists('app_url',$driverAppVersionControlForIos)) ? $driverAppVersionControlForIos['app_url'] : old('driver_app_url_for_ios')) : ''}}"
