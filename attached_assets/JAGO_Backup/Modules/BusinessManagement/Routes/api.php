...
Route::group(['prefix' => 'customer', 'middleware' => ['auth:api', 'maintenance_mode']], function () {
    Route::controller(\Modules\BusinessManagement\Http\Controllers\Api\CorporateApiController::class)->group(function () {
        Route::post('corporate/activate', 'activateCorporate');
        Route::post('corporate/deactivate', 'deactivateCorporate');
        Route::get('corporate/status', 'corporateStatus');
    });
});
