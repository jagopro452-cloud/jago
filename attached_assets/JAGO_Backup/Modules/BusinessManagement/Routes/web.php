...
use Modules\BusinessManagement\Http\Controllers\Web\Admin\BusinessSetup\CorporateController;
    ...
    Route::group(['prefix' => 'business', 'as' => 'business.'], function () {
        ...
        Route::group(['prefix' => 'corporate', 'as' => 'corporate.'], function () {
            Route::controller(CorporateController::class)->group(function () {
                ...
                Route::post('{id}/add-employee', 'addEmployee')->name('add-employee');
                Route::delete('{corporateId}/remove-employee/{userId}', 'removeEmployee')->name('remove-employee');
                Route::get('b2b-plans', 'b2bPlans')->name('b2b-plans');
                Route::post('b2b-plans/store', 'storeB2bPlan')->name('b2b-plans.store');
                Route::put('b2b-plans/update/{id}', 'updateB2bPlan')->name('b2b-plans.update');
                Route::post('b2b-plans/status/{id}', 'b2bPlanStatus')->name('b2b-plans.status');
            });
        });
