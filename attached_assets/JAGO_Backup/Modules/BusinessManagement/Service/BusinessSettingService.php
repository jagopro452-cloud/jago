...
class BusinessSettingService extends BaseService implements BusinessSettingServiceInterface
{
    ...
    public function updateSetting(array $data)
    {
        ...
        if (array_key_exists('subscription_model_enabled', $data)) {
            $data['subscription_model_enabled'] = 1;
        } else {
            $data['subscription_model_enabled'] = 0;
        }
        if (array_key_exists('parcel_commission_enabled', $data)) {
            $data['parcel_commission_enabled'] = 1;
        } else {
            $data['parcel_commission_enabled'] = 0;
        }
        if (array_key_exists('car_sharing_enabled', $data)) {
            $data['car_sharing_enabled'] = 1;
        } else {
            $data['car_sharing_enabled'] = 0;
        }
        if (array_key_exists('city_sharing_enabled', $data)) {
            $data['city_sharing_enabled'] = 1;
        } else {
            $data['city_sharing_enabled'] = 0;
        }
        if (array_key_exists('outstation_sharing_enabled', $data)) {
            $data['outstation_sharing_enabled'] = 1;
        } else {
            $data['outstation_sharing_enabled'] = 0;
        }
        if (array_key_exists('earning_model', $data)) {
            if ($data['earning_model'] === 'subscription') {
                $data['subscription_model_enabled'] = 1;
            } else {
                $data['subscription_model_enabled'] = 0;
            }
    ...
    public function storeTripFareSetting(array $data)
    {
        ...
        $absent_keys = ['driver_otp_confirmation_for_trip', 'add_intermediate_points', 'helper_service_enabled'];
        foreach ($absent_keys as $absent) {
            if (!array_key_exists($absent, $data)) {
                $businessInfo = $this->businessSettingRepository
    ...
    public function storeParcelSetting(array $data)
    {
        ...
        if (array_key_exists('parcel_receiver_otp_verification', $data)) {
            $data['parcel_receiver_otp_verification'] = '1';
        } else {
            $data['parcel_receiver_otp_verification'] = '0';
        }
        if (array_key_exists('senior_citizen_discount_enabled', $data)) {
            $data['senior_citizen_discount_enabled'] = '1';
        } else {
            $data['senior_citizen_discount_enabled'] = '0';
        }
        if (array_key_exists('student_discount_enabled', $data)) {
            $data['student_discount_enabled'] = '1';
        } else {
            $data['student_discount_enabled'] = '0';
        }
        if (array_key_exists('outstation_service_enabled', $data)) {
            $data['outstation_service_enabled'] = '1';
        } else {
            $data['outstation_service_enabled'] = '0';
        }
        foreach ($data as $key => $value) {
