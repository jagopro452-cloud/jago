...
class TripFareService extends BaseService implements TripFareServiceInterface
{
    ...
    public function create(array $data): ?Model
    {
        ...
        $defaultTripFareData = [
            ...
            "pickup_charge_per_km" => $data['pickup_charge_per_km'] ?? 0,
            "pickup_free_distance" => $data['pickup_free_distance'] ?? 0.5,
            "shared_discount_percent" => $data['shared_discount_percent'] ?? 30,
