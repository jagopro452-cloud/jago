...
class PaystackController extends Controller
{
    ...
    public function __construct(PaymentRequest $payment, User $user)
    {
        ...
        if ($values) {
            $config = array(
                'publicKey' => config('services.paystack.public_key', $values->public_key),
                'secretKey' => config('services.paystack.secret_key', $values->secret_key),
                'paymentUrl' => config('services.paystack.payment_url', 'https://api.paystack.co'),
                'merchantEmail' => config('services.paystack.merchant_email', $values->merchant_email),
            );
