    ...
    public function __construct(PaymentRequest $payment, User $user)
    {
        ...
        if (isset($paytm)) {
            ...
            $config = array(
                ...
                'PAYTM_MERCHANT_KEY' => config('services.paytm.merchant_key', $paytm->merchant_key),
                'PAYTM_MERCHANT_MID' => config('services.paytm.merchant_id', $paytm->merchant_id),
                'PAYTM_MERCHANT_WEBSITE' => config('services.paytm.merchant_website', $paytm->merchant_website_link),
                'PAYTM_REFUND_URL' => config('services.paytm.refund_url', $paytm->refund_url ?? ''),
                'PAYTM_STATUS_QUERY_URL' => config('services.paytm.status_query_url', $PAYTM_STATUS_QUERY_NEW_URL),
                'PAYTM_STATUS_QUERY_NEW_URL' => config('services.paytm.status_query_new_url', $PAYTM_STATUS_QUERY_NEW_URL),
                'PAYTM_TXN_URL' => config('services.paytm.txn_url', $PAYTM_TXN_URL),
            );
