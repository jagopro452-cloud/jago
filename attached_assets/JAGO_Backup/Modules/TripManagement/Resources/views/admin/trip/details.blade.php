                                        ...
                                        <div class="px-xl-3">
                                            <dl class="data-list gy-2 text-dark">
                                                ...
                                                @if($trip->fee?->admin_commission > 0)
                                                    <dt class="mt-2 pt-2 border-top">
                                                        <strong class="text-primary">{{ translate('admin_share') }}</strong>
                                                        <i class="bi bi-info-circle-fill text-primary tooltip-icon"
                                                            data-bs-toggle="tooltip"
                                                            data-bs-title="{{ translate('Platform fee + GST deducted from pilot wallet per ride') }}"></i>
                                                    </dt>
                                                    <dd class="m-0 mt-2 pt-2 border-top">
                                                        <strong class="text-primary">{{ set_currency_symbol($trip->fee->admin_commission) }}</strong>
                                                    </dd>
                                                @endif
