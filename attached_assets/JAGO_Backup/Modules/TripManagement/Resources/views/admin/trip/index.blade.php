            ...
            <form class="d-flex flex-column h-100" action="{{url()->full()}}" id="filterForm">
                ...
                <div class="offcanvas-body scrollbar-thin">
                    ...
                    <div class="mb-4 custom-input-grp position-relative">
                        ...
                        <select class="js-select-offcanvas" name="vehicle_category_type">
                            <option value="{{ALL}}" {{request() && request()->input('vehicle_category_type') == ALL ? "selected" : ""}}>
                                {{translate("All Service Types")}}
                            </option>
                            <option value="car" {{request() && request()->input('vehicle_category_type') == 'car' ? "selected" : ""}}>{{translate("Car")}}</option>
                            <option value="motor_bike" {{request() && request()->input('vehicle_category_type') == 'motor_bike' ? "selected" : ""}}>{{translate("Bike")}}</option>
                            <option value="auto" {{request() && request()->input('vehicle_category_type') == 'auto' ? "selected" : ""}}>{{translate("Auto")}}</option>
                        </select>
                    </div>
