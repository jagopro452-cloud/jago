    ...
    <table class="table table-borderless align-middle table-hover">
        ...
        <tr>
            ...
            <th class="text-center admin-commission">
                {{translate('admin')}} <br/> {{translate('share')}} ({{getSession('currency_symbol')}})
            </th>
        ...
        @forelse($trips as $key => $trip)
            <tr>
                ...
                <td class="text-center trip-type">
                    ...
                    @endif
                    @if($trip->vehicleCategory)
                        <span class="badge {{ $trip->vehicleCategory->type == 'car' ? 'badge-info' : ($trip->vehicleCategory->type == 'auto' ? 'badge-warning' : 'badge-success') }} d-block mt-1">
                ...
                <td class="text-center text-capitalize additional-fee">
                    ...
                    <div>{{translate('GST/Tax')}}: {{getCurrencyFormat($trip->fee?->vat_tax)}}</div>
                </td>
