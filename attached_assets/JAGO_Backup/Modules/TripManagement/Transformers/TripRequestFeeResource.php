...
class TripRequestFeeResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'cancellation_fee_admin_share' => $this->cancellation_fee_admin_share ?? 0,
            'cancellation_fee_driver_share' => $this->cancellation_fee_driver_share ?? 0,
            'cancelled_by' => $this->cancelled_by,
            'waiting_fee' => $this->waiting_fee,
            'pickup_charge' => $this->pickup_charge ?? 0,
