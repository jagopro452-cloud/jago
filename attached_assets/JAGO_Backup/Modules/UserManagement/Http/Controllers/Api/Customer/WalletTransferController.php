...
class WalletTransferController extends Controller
{
    ...
    public function transferJagoToMartWallet(Request $request)
    {
        ...
        if (checkSelfExternalConfiguration()) {
            ...
            try {
                $response = Http::post($martBaseUrl . '/api/v1/customer/wallet/transfer-mart-from-jago',
                    [
    ...
    public function transferJagoFromMartWallet(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'currency' => 'required',
            'amount' => 'required',
                    ...
                    if ($martCustomerResponse['status']) {
                        ...
                        if ($customer && $customer->userAccount) {
                            ...
                            sendDeviceNotification(
                                ...
                                title:translate("wallet_transfer_jago_from_mart") ,
                                description: translate("you_transfer_your_wallet_balance_jago_from_mart"),
                                status: 1
                            );
                            $data = [
                                'status' => true,
