                                                           ...
                                                           class="media d-inline-flex align-items-center gap-10">
                                                            ...
                                                            <span class="d-flex align-items-center gap-1">
                                                                ...
                                                                @if($driver->driverDetails->is_suspended)
                                                                    @if($driver->driverDetails->suspend_reason === 'negative_balance_auto_lock')
                                                                        <span class="badge bg-danger fs-10" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{ translate('Locked - Negative Balance') }}">₹</span>
                                                                    @else
