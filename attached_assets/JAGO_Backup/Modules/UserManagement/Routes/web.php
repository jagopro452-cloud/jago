...
use Modules\UserManagement\Http\Controllers\Web\Admin\SubscriptionController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'driver', 'as' => 'driver.'], function () {
        Route::controller(DriverController::class)->group(function () {
            ...
            Route::post('unlock-negative-balance/{id}', 'unlockNegativeBalance')->name('unlock-negative-balance');
        });
    ...
    Route::group(['prefix' => 'subscription', 'as' => 'subscription.'], function () {
        Route::controller(SubscriptionController::class)->group(function () {
            ...
            Route::post('toggle-lock/{driverId}', 'toggleLock')->name('toggle-lock');
