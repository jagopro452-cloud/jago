...
class DriverResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'is_negative_balance_locked' => ($this->driverDetails?->is_suspended && $this->driverDetails?->suspend_reason === 'negative_balance_auto_lock') ? true : false,
            'wallet_balance' => round($this->userAccount?->wallet_balance ?? 0, 2),
            'negative_balance_limit' => (float)(get_cache('negative_balance_limit') ?? 200),
