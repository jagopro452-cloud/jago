...
import 'package:jago_pilot_app/features/auth/domain/repositories/auth_repository.dart';
import 'package:jago_pilot_app/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:jago_pilot_app/features/auth/domain/services/auth_service.dart';
import 'package:jago_pilot_app/features/auth/domain/services/auth_service_interface.dart';
import 'package:jago_pilot_app/features/chat/controllers/chat_controller.dart';
import 'package:jago_pilot_app/features/chat/domain/repositories/chat_repository.dart';
import 'package:jago_pilot_app/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:jago_pilot_app/features/chat/domain/services/chat_service.dart';
import 'package:jago_pilot_app/features/chat/domain/services/chat_service_interface.dart';
...
import 'package:jago_pilot_app/features/face_verification/domain/repositories/face_verification_repository.dart';
import 'package:jago_pilot_app/features/face_verification/domain/repositories/face_verification_repository_interface.dart';
import 'package:jago_pilot_app/features/face_verification/domain/services/face_verification_service.dart';
import 'package:jago_pilot_app/features/face_verification/domain/services/face_verification_service_interface.dart';
import 'package:jago_pilot_app/features/help_and_support/controllers/help_and_support_controller.dart';
import 'package:jago_pilot_app/features/help_and_support/domain/repositories/help_and_support_repository.dart';
import 'package:jago_pilot_app/features/help_and_support/domain/repositories/help_and_support_repository_interface.dart';
import 'package:jago_pilot_app/features/help_and_support/domain/services/help_and_support_service.dart';
import 'package:jago_pilot_app/features/help_and_support/domain/services/help_and_support_service_interface.dart';
import 'package:jago_pilot_app/features/leaderboard/controllers/leader_board_controller.dart';
import 'package:jago_pilot_app/features/leaderboard/domain/repositories/leader_board_repository.dart';
import 'package:jago_pilot_app/features/leaderboard/domain/repositories/leader_board_repository_interface.dart';
import 'package:jago_pilot_app/features/leaderboard/domain/services/leader_board_service.dart';
...
import 'package:jago_pilot_app/features/location/domain/repositories/location_repository.dart';
import 'package:jago_pilot_app/features/location/domain/repositories/location_repository_interface.dart';
import 'package:jago_pilot_app/features/location/domain/services/location_service.dart';
...
import 'package:jago_pilot_app/features/map/controllers/otp_time_count_controller.dart';
import 'package:jago_pilot_app/features/notification/controllers/notification_controller.dart';
import 'package:jago_pilot_app/features/notification/domain/repositories/notification_repository.dart';
import 'package:jago_pilot_app/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:jago_pilot_app/features/notification/domain/services/notification_service.dart';
import 'package:jago_pilot_app/features/notification/domain/services/notification_service_interface.dart';
import 'package:jago_pilot_app/features/out_of_zone/controllers/out_of_zone_controller.dart';
import 'package:jago_pilot_app/features/out_of_zone/domain/repositories/out_of_zone_repository.dart';
import 'package:jago_pilot_app/features/out_of_zone/domain/repositories/out_of_zone_repository_interface.dart';
import 'package:jago_pilot_app/features/out_of_zone/domain/service/out_of_zone_service.dart';
import 'package:jago_pilot_app/features/out_of_zone/domain/service/out_of_zone_service_interface.dart';
import 'package:jago_pilot_app/features/profile/controllers/profile_controller.dart';
import 'package:jago_pilot_app/features/profile/domain/repositories/profile_repository.dart';
import 'package:jago_pilot_app/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:jago_pilot_app/features/profile/domain/services/profile_service.dart';
import 'package:jago_pilot_app/features/profile/domain/services/profile_service_interface.dart';
import 'package:jago_pilot_app/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:jago_pilot_app/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:jago_pilot_app/features/refer_and_earn/domain/repositories/refer_earn_repository_intertface.dart';
import 'package:jago_pilot_app/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:jago_pilot_app/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:jago_pilot_app/features/review/controllers/review_controller.dart';
import 'package:jago_pilot_app/features/review/domain/repositories/review_repository.dart';
import 'package:jago_pilot_app/features/review/domain/repositories/review_repository_interface.dart';
import 'package:jago_pilot_app/features/review/domain/services/review_service.dart';
import 'package:jago_pilot_app/features/review/domain/services/review_service_interface.dart';
import 'package:jago_pilot_app/features/ride/controllers/ride_controller.dart';
import 'package:jago_pilot_app/features/ride/domain/repositories/ride_repository.dart';
import 'package:jago_pilot_app/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:jago_pilot_app/features/ride/domain/services/ride_service.dart';
import 'package:jago_pilot_app/features/ride/domain/services/ride_service_interface.dart';
import 'package:jago_pilot_app/features/safety_setup/controllers/safety_alert_controller.dart';
import 'package:jago_pilot_app/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:jago_pilot_app/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:jago_pilot_app/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:jago_pilot_app/features/safety_setup/domain/services/safety_alert_service_interface.dart';
import 'package:jago_pilot_app/features/setting/controllers/setting_controller.dart';
import 'package:jago_pilot_app/features/splash/controllers/splash_controller.dart';
import 'package:jago_pilot_app/features/splash/domain/repositories/splash_repository.dart';
...
import 'package:jago_pilot_app/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:jago_pilot_app/features/splash/domain/services/splash_service.dart';
import 'package:jago_pilot_app/features/splash/domain/services/splash_service_interface.dart';
import 'package:jago_pilot_app/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:jago_pilot_app/features/trip/domain/services/trip_service.dart';
import 'package:jago_pilot_app/features/trip/domain/services/trip_service_interface.dart';
import 'package:jago_pilot_app/features/subscription/controllers/subscription_controller.dart';
import 'package:jago_pilot_app/features/subscription/domain/repositories/subscription_repository.dart';
import 'package:jago_pilot_app/features/subscription/domain/repositories/subscription_repository_interface.dart';
import 'package:jago_pilot_app/features/subscription/domain/services/subscription_service.dart';
import 'package:jago_pilot_app/features/subscription/domain/services/subscription_service_interface.dart';
import 'package:jago_pilot_app/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:jago_pilot_app/features/wallet/domain/services/wallet_service.dart';
import 'package:jago_pilot_app/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:jago_pilot_app/localization/language_model.dart';
...
import 'package:jago_pilot_app/features/trip/domain/repositories/trip_repository.dart';
import 'package:jago_pilot_app/features/wallet/controllers/wallet_controller.dart';
import 'package:jago_pilot_app/features/wallet/domain/repositories/wallet_repository.dart';
