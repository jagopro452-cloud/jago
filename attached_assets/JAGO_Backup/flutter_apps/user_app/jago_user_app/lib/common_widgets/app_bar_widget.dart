...
import 'package:jago_user_app/common_widgets/calender_widget.dart';
import 'package:jago_user_app/common_widgets/drop_down_widget.dart';
                  ...
                  GetBuilder<LocationController>(builder: (locationController) {
                    return Padding(
                      ...
                      child: Row(mainAxisAlignment: isHome ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                        Icon(Icons.place_outlined, color: Colors.white.withValues(alpha: 0.8), size: 16),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        ...
        child: Icon(Icons.info, color: Colors.white.withValues(alpha: 0.8)),
      ),
    );
  }
}
