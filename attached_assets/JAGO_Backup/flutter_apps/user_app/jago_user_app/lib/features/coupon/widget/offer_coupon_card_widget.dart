...
import 'package:jago_user_app/features/coupon/domain/models/coupon_model.dart';
                  ...
                  Stack(children: [
                    Container(width: 65, height: 80,
                      ...
                      child: Image.network(coupon.imageUrl ?? '',
                        cacheWidth: 130, cacheHeight: 160,
                        errorBuilder: (context, error, stackTrace) => Image.asset(Images.placeholder, fit: BoxFit.contain),
