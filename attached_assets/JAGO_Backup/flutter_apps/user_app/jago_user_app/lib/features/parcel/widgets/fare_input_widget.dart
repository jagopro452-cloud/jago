    ...
    return GetBuilder<RideController>(builder: (rideController) {
      return GetBuilder<ParcelController>(builder: (parcelController) {
        return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          (rideController.isSubmit || parcelController.isLoadingVehicleTypes) ?
              ...
              ButtonWidget(
                ...
                onPressed: () {
                  if(widget.fromRide) {
                    ...
                    Get.find<AuthController>().saveFindingRideCreatedTime();
                    String zoneId = rideController.parcelEstimatedFare?.data?.zoneId?.toString() ?? '';
                    if(zoneId.isNotEmpty) {
                      Get.find<ParcelController>().updateParcelState(ParcelDeliveryState.selectVehicle);
                      Get.find<ParcelController>().focusOnBottomSheet(widget.expandableKey);
                      Get.find<ParcelController>().getParcelVehicleTypes(zoneId);
                    } else {
