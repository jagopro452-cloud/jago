...
import 'package:jago_user_app/features/spin_wheel/screens/spin_wheel_screen.dart';
          ...
          bottomNavigationBar: GetBuilder<PaymentController>(builder: (reviewController) {
            return Container(
              ...
              child: Column(
                ...
                children: [
                  GetBuilder<SpinWheelController>(builder: (spinController) {
                    if (!spinController.isActive) return const SizedBox();
                    return Padding(
                      padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall),
                      child: InkWell(
                        onTap: () => Get.to(() => SpinWheelScreen(tripRequestId: widget.tripId)),
                        child: Container(
                          width: double.infinity,
                          padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
                          decoration: BoxDecoration(
                            gradient: LinearGradient(colors: [Theme.of(context).primaryColor, const Color(0xFF2563EB)]),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('spin_and_win'.tr, style: textSemiBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeDefault)),
                            ],
                          ),
                        ),
                      ),
