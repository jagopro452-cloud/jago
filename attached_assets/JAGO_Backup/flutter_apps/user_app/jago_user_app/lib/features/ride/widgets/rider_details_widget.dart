...
import 'package:jago_user_app/features/ride/widgets/bidding_list_screen.dart';
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Expanded(child: Text.rich(TextSpan(
                      ...
                      children:  [
                        ...
                        if(widget.bidding.driver?.vehicle?.licencePlateNumber != null)
                          TextSpan(text: ' (${widget.bidding.driver!.vehicle!.licencePlateNumber})',
