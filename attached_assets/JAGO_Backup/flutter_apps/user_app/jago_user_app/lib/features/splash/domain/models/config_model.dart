class ConfigModel {
  ...
  double? gstPercent;
  bool? carSharingEnabled;
  bool? helperServiceEnabled;
  ...
  ConfigModel(
      {this.businessName,
        ...
        this.gstPercent,
        this.carSharingEnabled,
        this.helperServiceEnabled,
      });
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    earningModel = json['earning_model'] ?? 'commission';
    commissionPercent = double.tryParse('${json['commission_percent']}') ?? 0;
    platformFeeAmount = double.tryParse('${json['platform_fee_amount']}') ?? 0;
    gstPercent = double.tryParse('${json['gst_percent']}') ?? 0;
    carSharingEnabled = json['car_sharing_enabled'] ?? false;
    helperServiceEnabled = json['helper_service_enabled'] ?? false;
  }
