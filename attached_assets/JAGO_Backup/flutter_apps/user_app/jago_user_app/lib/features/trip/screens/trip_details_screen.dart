...
import 'package:jago_user_app/common_widgets/custom_pop_scope_widget.dart';
...
import 'package:jago_user_app/features/refund_request/screens/refund_request_screen.dart';
...
import 'package:jago_user_app/features/safety_setup/widgets/safety_alert_bottomsheet_widget.dart';
import 'package:jago_user_app/features/set_destination/widget/schedule_date_time_picker_widget.dart';
import 'package:jago_user_app/features/trip/controllers/trip_controller.dart';
import 'package:jago_user_app/features/trip/widgets/parcel_details_widget.dart';
import 'package:jago_user_app/features/trip/widgets/parcel_returning_process_widget.dart';
import 'package:jago_user_app/features/trip/widgets/refund_details_widget.dart';
import 'package:jago_user_app/features/trip/widgets/trip_details.dart';
import 'package:jago_user_app/features/trip/widgets/trip_details_top_section_widget.dart';
import 'package:jago_user_app/features/trip/widgets/trip_safety_sheet_details_widget.dart';
...
import 'package:jago_user_app/helper/trip_details_helper.dart';
                      ...
                      Expanded(child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Column(children: [
                            ...
                            if(rideController.tripDetails?.currentStatus == AppConstants.completed && rideController.tripDetails?.type != 'parcel')...[
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                              InkWell(
                                onTap: () => Get.to(() => GstInvoiceScreen(tripId: widget.tripId)),
                                child: Container(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    Icon(Icons.receipt_long, size: 20, color: Theme.of(context).primaryColor),
                                    const SizedBox(width: Dimensions.paddingSizeSmall),
                                    Text('View GST Invoice', style: textSemiBold.copyWith(
                              ...
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                              InkWell(
                                onTap: () => Get.to(() => ReportOverchargeScreen(tripId: widget.tripId)),
                                child: Container(
                                  width: double.infinity,
                                  padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: Dimensions.paddingSizeDefault),
                                  decoration: BoxDecoration(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                    Icon(Icons.warning_amber_rounded, size: 20, color: Colors.red.shade600),
                                    const SizedBox(width: Dimensions.paddingSizeSmall),
                                    Text('Report Overcharge', style: textSemiBold.copyWith(
                                      fontSize: Dimensions.fontSizeDefault,
