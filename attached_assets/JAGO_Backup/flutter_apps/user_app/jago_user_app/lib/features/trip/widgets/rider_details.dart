...
import 'package:jago_user_app/features/parcel/widgets/contact_widget.dart';
              ...
              Row(children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    if(rideController.tripDetails?.vehicleCategory?.name != null)
                      Container(
                        ...
                        child: Text(
                          rideController.tripDetails!.vehicleCategory!.name!,
