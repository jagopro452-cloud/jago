...
import 'package:jago_user_app/features/address/domain/repositories/address_repository_interface.dart';
import 'package:jago_user_app/features/address/domain/services/address_service.dart';
import 'package:jago_user_app/features/address/domain/services/address_service_interface.dart';
import 'package:jago_user_app/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:jago_user_app/features/auth/domain/services/auth_service.dart';
import 'package:jago_user_app/features/auth/domain/services/auth_service_interface.dart';
import 'package:jago_user_app/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:jago_user_app/features/coupon/domain/services/coupon_service.dart';
import 'package:jago_user_app/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:jago_user_app/features/home/domain/repositories/category_repo.dart';
import 'package:jago_user_app/features/location/domain/repositories/location_repository.dart';
import 'package:jago_user_app/features/location/domain/repositories/location_repository_interface.dart';
import 'package:jago_user_app/features/location/domain/services/location_service.dart';
import 'package:jago_user_app/features/location/domain/services/location_service_interface.dart';
import 'package:jago_user_app/features/message/domain/repositories/message_repository.dart';
import 'package:jago_user_app/features/message/domain/repositories/message_repository_interface.dart';
import 'package:jago_user_app/features/message/domain/services/message_service.dart';
import 'package:jago_user_app/features/message/domain/services/message_service_interface.dart';
import 'package:jago_user_app/features/my_level/controller/level_controller.dart';
import 'package:jago_user_app/features/my_level/domain/repositories/level_repository.dart';
import 'package:jago_user_app/features/my_level/domain/repositories/level_repository_interface.dart';
import 'package:jago_user_app/features/my_level/domain/services/level_service.dart';
import 'package:jago_user_app/features/my_level/domain/services/level_service_interface.dart';
import 'package:jago_user_app/features/my_offer/controller/offer_controller.dart';
import 'package:jago_user_app/features/my_offer/domain/repositories/offer_repository.dart';
import 'package:jago_user_app/features/my_offer/domain/repositories/offer_repository_interface.dart';
import 'package:jago_user_app/features/my_offer/domain/services/offer_service.dart';
import 'package:jago_user_app/features/my_offer/domain/services/offer_service_interface.dart';
import 'package:jago_user_app/features/notification/controllers/notification_controller.dart';
import 'package:jago_user_app/features/notification/domain/repositories/notification_repository.dart';
import 'package:jago_user_app/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:jago_user_app/features/notification/domain/services/notification_service.dart';
import 'package:jago_user_app/features/notification/domain/services/notification_service_interface.dart';
import 'package:jago_user_app/features/onboard/controllers/on_board_page_controller.dart';
import 'package:jago_user_app/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:jago_user_app/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:jago_user_app/features/parcel/domain/services/parcel_service.dart';
import 'package:jago_user_app/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:jago_user_app/features/payment/controllers/payment_controller.dart';
import 'package:jago_user_app/features/payment/domain/repositories/payment_repository.dart';
import 'package:jago_user_app/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:jago_user_app/features/payment/domain/services/payment_service.dart';
import 'package:jago_user_app/features/payment/domain/services/payment_service_interface.dart';
import 'package:jago_user_app/features/profile/domain/repositories/profile_repository.dart';
import 'package:jago_user_app/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:jago_user_app/features/profile/domain/services/profile_service.dart';
import 'package:jago_user_app/features/profile/domain/services/profile_service_interface.dart';
import 'package:jago_user_app/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:jago_user_app/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:jago_user_app/features/refer_and_earn/domain/repositories/refer_earn_repository_interface.dart';
import 'package:jago_user_app/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:jago_user_app/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:jago_user_app/features/refund_request/controllers/refund_request_controller.dart';
import 'package:jago_user_app/features/refund_request/domain/repositories/refund_request_repository.dart';
import 'package:jago_user_app/features/refund_request/domain/repositories/refund_request_repository_interface.dart';
import 'package:jago_user_app/features/refund_request/domain/services/refund_request_service.dart';
import 'package:jago_user_app/features/refund_request/domain/services/refund_request_service_interface.dart';
import 'package:jago_user_app/features/ride/domain/repositories/ride_repository.dart';
import 'package:jago_user_app/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:jago_user_app/features/ride/domain/services/ride_service.dart';
import 'package:jago_user_app/features/ride/domain/services/ride_service_interface.dart';
import 'package:jago_user_app/features/safety_setup/controllers/safety_alert_controller.dart';
import 'package:jago_user_app/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:jago_user_app/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:jago_user_app/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:jago_user_app/features/safety_setup/domain/services/safety_alert_service_interface.dart';
import 'package:jago_user_app/features/call/domain/repositories/call_repository.dart';
import 'package:jago_user_app/features/call/controllers/call_controller.dart';
import 'package:jago_user_app/features/splash/domain/repositories/config_repository.dart';
import 'package:jago_user_app/features/splash/domain/repositories/config_repository_interface.dart';
import 'package:jago_user_app/features/splash/domain/services/config_service.dart';
import 'package:jago_user_app/features/splash/domain/services/config_service_interface.dart';
import 'package:jago_user_app/features/support/controllers/help_support_controller.dart';
import 'package:jago_user_app/features/trip/controllers/trip_controller.dart';
import 'package:jago_user_app/features/auth/controllers/auth_controller.dart';
import 'package:jago_user_app/features/coupon/controllers/coupon_controller.dart';
import 'package:jago_user_app/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:jago_user_app/features/dashboard/controllers/bottom_menu_controller.dart';
import 'package:jago_user_app/features/address/controllers/address_controller.dart';
import 'package:jago_user_app/features/home/controllers/banner_controller.dart';
import 'package:jago_user_app/features/home/controllers/category_controller.dart';
import 'package:jago_user_app/features/address/domain/repositories/address_repository.dart';
import 'package:jago_user_app/features/home/domain/repositories/banner_repo.dart';
...
import 'package:jago_user_app/features/auth/domain/repositories/auth_repository.dart';
...
import 'package:jago_user_app/features/profile/controllers/profile_controller.dart';
...
import 'package:jago_user_app/features/trip/domain/repositories/trip_repository.dart';
import 'package:jago_user_app/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:jago_user_app/features/trip/domain/services/service.dart';
import 'package:jago_user_app/features/trip/domain/services/service_interface.dart';
import 'package:jago_user_app/features/spin_wheel/controllers/spin_wheel_controller.dart';
import 'package:jago_user_app/features/spin_wheel/domain/repositories/spin_wheel_repository.dart';
...
import 'package:jago_user_app/features/car_sharing/domain/repositories/car_sharing_repository.dart';
...
import 'package:jago_user_app/features/wallet/controllers/wallet_controller.dart';
import 'package:jago_user_app/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:jago_user_app/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:jago_user_app/features/wallet/domain/services/wallet_service.dart';
import 'package:jago_user_app/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:jago_user_app/localization/language_model.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => SpinWheelService(spinWheelRepositoryInterface: Get.find()));
  ...
  Get.lazyPut(() => CarSharingService(carSharingRepositoryInterface: Get.find()));
  ...
  Get.lazyPut(() => SpinWheelRepository(apiClient: Get.find()));
  ...
  Get.lazyPut(() => CarSharingRepository(apiClient: Get.find()));
  ...
  Get.lazyPut(() => SpinWheelController(spinWheelService: Get.find()));
  ...
  Get.lazyPut(() => CarSharingController(carSharingService: Get.find()));

  Get.lazyPut(() => CallRepository(apiClient: Get.find()));
  Get.lazyPut(() => CallController(callRepository: Get.find()));
  ...
  SpinWheelRepositoryInterface spinWheelRepositoryInterface = SpinWheelRepository(apiClient: Get.find());
  Get.lazyPut(() => spinWheelRepositoryInterface);
  SpinWheelServiceInterface spinWheelServiceInterface = SpinWheelService(spinWheelRepositoryInterface: Get.find());
  Get.lazyPut(() => spinWheelServiceInterface);
  ...
  CarSharingRepositoryInterface carSharingRepositoryInterface = CarSharingRepository(apiClient: Get.find());
  Get.lazyPut(() => carSharingRepositoryInterface);
  CarSharingServiceInterface carSharingServiceInterface = CarSharingService(carSharingRepositoryInterface: Get.find());
  Get.lazyPut(() => carSharingServiceInterface);
