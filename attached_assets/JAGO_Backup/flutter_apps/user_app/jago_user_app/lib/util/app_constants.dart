...
import 'package:jago_user_app/features/onboard/domain/models/on_boarding_model.dart';
import 'package:jago_user_app/localization/language_model.dart';
import 'package:jago_user_app/util/images.dart';

class AppConstants {
  static const String appName = 'JAGO';
  ...
  static const String parcelVehicleTypes = '/api/customer/parcel/vehicle-types';
  ...
  static const String transferMoneyFromJagoToMart = '/api/customer/wallet/transfer-jago-to-mart';
  ...
  static const String callStart = '/api/calls/start';
  static const String callSignal = '/api/calls/';
  static const String callPoll = '/api/calls/';
  static const String callStatus = '/api/calls/';
  static const String callIncoming = '/api/calls/incoming';
  static const String spinWheelConfig = '/api/customer/spin-wheel/config';
  static const String spinWheelSpin = '/api/customer/spin-wheel/spin';
  static const String spinWheelHistory = '/api/customer/spin-wheel/history';
  static const String carSharingFindRides = '/api/customer/car-sharing/find-shared-rides';
  static const String carSharingJoinRide = '/api/customer/car-sharing/join-shared-ride';
  static const String carSharingPassengers = '/api/customer/car-sharing/passengers';
  static const String carSharingAvailableSeats = '/api/customer/car-sharing/available-seats';
  static const String carSharingFareEstimate = '/api/customer/car-sharing/fare-estimate';
  static const String carSharingConfig = '/api/customer/car-sharing/config';
  static const String carSharingOffers = '/api/customer/car-sharing/offers';
  static const String gstInvoice = '/api/invoice/trip/';
  static const String reportOvercharge = '/api/customer/ride/report-overcharge';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.india, languageName: 'हिन्दी', countryCode: 'IN', languageCode: 'hi',),
    LanguageModel(imageUrl: Images.india, languageName: 'తెలుగు', countryCode: 'IN', languageCode: 'te',),
