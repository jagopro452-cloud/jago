        ...
        {isLoading ? (
          ...
          <div>
            <div className="row g-3 mb-4">
              {[
                { label: "Total Trips", val: driver.completedTrips || 0, icon: "bi-car-front", color: "#4f46e5" },
  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className="row g-3 mb-4">
          {[
            { label: "Total Completed Trips", val: totalTrips, icon: "bi-car-front-fill", color: "#4f46e5", bg: "linear-gradient(135deg,#4f46e515,#818cf815)" },
