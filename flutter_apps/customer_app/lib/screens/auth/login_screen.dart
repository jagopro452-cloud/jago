...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
    ...
    try {
      await FirebaseOtpService.sendOtp(
        ...
        onAutoVerify: (idToken) async {
          // Auto-verified! Complete login directly
          if (!mounted) return;
          setState(() => _loading = true);
          final verifyRes = await AuthService.verifyFirebaseToken(idToken, phone, 'customer');
          if (!mounted) return;
          setState(() => _loading = false);
          if (verifyRes['success'] == true) {
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => const HomeScreen()), (_) => false);
          } else {
            // Auto-verify failed, let user enter OTP manually
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      // Use stored _firebaseVerificationId, fallback to static in FirebaseOtpService
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            ...
                            errorBuilder: (_, __, ___) => Center(
                              child: Text('J', style: GoogleFonts.poppins(
      ...
      child: PinFieldAutoFill(
        ...
        decoration: UnderlineDecoration(
          textStyle: GoogleFonts.poppins(
            ...
            letterSpacing: 4, color: JT.textPrimary,
          ),
