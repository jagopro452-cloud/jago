...
class _CarSharingScreenState extends State<CarSharingScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildRidesList() {
    if (_loading) return const Center(child: CircularProgressIndicator(color: Color(0xFF1E6DE5)));
  ...
  Widget _buildMyBookings() {
    if (_myLoading) return const Center(child: CircularProgressIndicator(color: Color(0xFF1E6DE5)));
