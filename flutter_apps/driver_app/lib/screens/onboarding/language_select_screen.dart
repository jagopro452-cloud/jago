                      ...
                      itemBuilder: (_, i) {
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: selected ? _orange.withOpacity(0.08) : cardBg,
                              borderRadius: BorderRadius.circular(14),
                              border: Border.all(
                                color: selected ? _orange : (isDark ? Colors.white12 : const Color(0xFFE5E7EB)),
                                width: selected ? 2 : 1,
                              ),
                              boxShadow: selected ? [
                                BoxShadow(color: _orange.withOpacity(0.2), blurRadius: 10, offset: const Offset(0, 3)),
                              ] : null,
                            ),
                            child: Padding(
                              ...
                              child: Row(children: [
                                  ...
                                  children: [
                                    Text(lang['nativeName']!,
                                      style: TextStyle(
                                        ...
                                        color: selected ? _orange : textMain,
                                      )),
                                    Text(lang['name']!,
                                      style: TextStyle(
                                        fontSize: 11,
                                        color: selected ? _orange.withOpacity(0.7) : textSub,
                                ...
                                AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: selected ? _orange : (isDark ? Colors.white24 : Colors.grey.shade300),
                                      width: 2,
                                    ),
                                  ),
                                  child: selected
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFF060D1E), Color(0xFF0D1B3E)],
