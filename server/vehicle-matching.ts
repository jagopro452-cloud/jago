...
function allowedVehicleKeys(meta: VehicleCategoryMeta): string[] {
  ...
  switch (key) {
    case "bike":
    case "bike_ride":
      return ["bike", "bike_ride"];
    case "auto":
    case "auto_ride":
      return ["auto", "auto_ride"];
    case "mini_car":
    case "car":
    case "cab":
      return ["mini_car", "car", "cab"];
    case "sedan":
      return ["sedan"];
    case "suv":
    case "suv_xl":
...
export function getPlatformServiceKeyForCategory(meta: VehicleCategoryMeta | null): string | null {
  ...
  if (key === "bike" || key === "bike_ride") return "bike_ride";
  if (key === "auto" || key === "auto_ride") return "auto_ride";
  if (key === "mini_car" || key === "car" || key === "cab" || key === "pool_mini") return "mini_car";
